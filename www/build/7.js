...
var ItemDetailPage = /** @class */ (function () {
    ...
    ItemDetailPage.prototype.openItem = function (item) {
        this.navCtrl.push('MonthDetailPage', { item: item });
    };
    ItemDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-item-detail',template:/*ion-inline-start:"C:\Users\define\harry\Ionic3-Multi-Purpose-Theme\src\pages\item-detail\item-detail.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>{{ item.name }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n    <div class="item-profile" text-center #profilePic [style.background-image]="\'url(\' + item.profilePic + \')\'">\n      </div>\n    \n      <div class="item-detail" padding>\n        <h2>{{item.name}}</h2>\n        <p>{{item.about}}</p>\n      </div>\n      <hr>\n  <ion-list>\n      \n    <ion-item-sliding class="cssForRoundSLidingItems" *ngFor="let item of currentItems" #slidingItem>\n      <ion-item (click)="openItem(item)">\n        <ion-avatar item-start>\n          <img [src]="item.profilePic">\n        </ion-avatar>\n        <h2>{{item.name}}</h2>\n        <p>{{item.about}}</p>\n      </ion-item>\n    </ion-item-sliding>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\define\harry\Ionic3-Multi-Purpose-Theme\src\pages\item-detail\item-detail.html"*/
        }),
