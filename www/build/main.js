...
var map = {
	...
	"../pages/month-detail/month-detail.module": [
		337,
		5
	],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_9_ionic_angular__["f" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_12__app_component__["a" /* MyApp */], {}, {
                    links: [
                        ...
                        { loadChildren: '../pages/month-detail/month-detail.module#MonthDetailPageModule', name: 'MonthDetailPage', segment: 'month-detail', priority: 'low', defaultHistory: [] },
